...
node () {
    ...
    stage ('Inno package build') {
        ...
        bat '"C:\\Program Files (x86)\\Inno Setup 6\\iscc.exe" inno.iss /O"C:\\Users\\jenkins\\jenkins\\" /DApplicationVersion=${majorminorversion}.%BUILD_NUMBER%' 
	}
	stage ('Moving package to NAS') {
	    bat 'move "C:\\Users\\jenkins\\jenkins\\Ashes ${majorminorversion}.%BUILD_NUMBER%.exe" "\\\\boreli-nas\\Studio Boreli\\Releases\\Ashes\\Ashes ${majorminorversion}.%BUILD_NUMBER%.exe"'
	}
